...
class GatsbyTypescriptAppProject extends TypeScriptAppProject {
    constructor(options: TypeScriptProjectOptions) {
        ...
        super({
            ...
            tsconfig: {
                compilerOptions: {
                    ...
                    jsx: TypeScriptJsxMode.REACT /* Specify what JSX code is generated. */,
                    ...
                    moduleResolution:
                        TypeScriptModuleResolution.NODE /* Specify how TypeScript looks up a file from a given module specifier. */,
        ...
        this.gitignore.addPatterns(".cache", "public", "src/gatsby-types.d.ts");

        this.addTask("dev", {
            exec: "gatsby develop",
            description: "Run Gatsby in development mode",
        });

        this.addTask("serve", {
            exec: "gatsby serve",
            description: "Run Gatsby in serve mode",
        });

        this.addTask("clean", {
            exec: "gatsby clean",
            description: "Gatsby clean removes the .cache folder",
        });
